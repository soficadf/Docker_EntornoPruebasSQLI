...
try {
    $result = mysqli_query($conexion,"SELECT nota FROM cursa WHERE asignatura_id = $asignatura AND alumno_id= $alumno");
...
try {
$result =  mysqli_query($conexion,"SELECT nombre,apellido FROM alumno WHERE matricula= $alumno");
} catch (mysqli_sql_exception $ex) {
    $conexion->close();
...
<body class="loggedin">
    ...
    echo ' <div class="formulario"> <form action="http://127.0.0.1/version3/Sistema_Calificaciones/backend/procesar_nota.php" method="post">
...
?>
    ...
    <div class=foto2 style="background-image: url('http://127.0.0.1/version3/Sistema_Calificaciones/images/2.png');">
