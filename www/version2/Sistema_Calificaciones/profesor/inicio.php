...
<body class="loggedin">
    ...
    <div class=foto style="background-image: url('http://127.0.0.1/version2/Sistema_Calificaciones/images/2.png');">
        <img src="http://127.0.0.1/version2/Sistema_Calificaciones/images/LOGOTIPO.png" alt="Logo de la universidad">
    </div>
