...
<body class="loggedin">
    ...
    echo ' <div class="formulario"> <form action="http://127.0.0.1/version2/Sistema_Calificaciones/backend/procesar_nota.php" method="post">
...
?>
    ...
    <div class=foto2 style="background-image: url('http://127.0.0.1/version2/Sistema_Calificaciones/images/2.png');">
